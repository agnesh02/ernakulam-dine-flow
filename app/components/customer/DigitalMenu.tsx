...
interface DigitalMenuProps {
  ...
  existingOrderGroupId?: string | null; // Existing order group ID to continue adding orders
}
...
export const DigitalMenu = ({ cart, setCart, onOrderPlaced, selectedRestaurant, onBackToRestaurants, existingOrderGroupId }: DigitalMenuProps) => {
              ...
              handler: async (response: { razorpay_order_id: string; razorpay_payment_id: string; razorpay_signature: string }) => {
                try {
                  ...
                  const result = await orderAPI.verifyPrepayment({
                    ...
                    items: orderItems,
                    orderType: orderType,
                    existingOrderGroupId: existingOrderGroupId || undefined,
                  });
